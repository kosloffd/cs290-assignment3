...
function returnObjectLiteral() {
  //your code here
  var snack = { type: "Goldfish", brand: "Pepperidge Farm", flavor: "Cheddar",
		count: 2000};
...
{
	if(n <= this.sentLog.length)
	{
		var sentMessage = this.sentLog[n];
		return sentMessage;
	}
